...
@WebServlet(urlPatterns= {"/product/thoi-trang-nam"})
public class ListThoiTrangNamController extends HttpServlet{
	private DanhMucSanPhamDao danhMucDao = new DanhMucSanPhamDaoImp();
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		req.setAttribute("listProduct", danhMucDao.getByProduct(1));
		RequestDispatcher requestDispatcher = req.getRequestDispatcher("/view/listThoiTrangNam.jsp");

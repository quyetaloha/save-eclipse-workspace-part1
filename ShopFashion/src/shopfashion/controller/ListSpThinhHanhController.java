...
@WebServlet(urlPatterns = { "/product/san-pham-thinh-hanh" })
public class ListSpThinhHanhController extends HttpServlet {
	private DanhMucSanPhamDao danhMucDao = new DanhMucSanPhamDaoImp();
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		req.setAttribute("listProduct", danhMucDao.getByProduct(7));
		RequestDispatcher requestDispatcher = req.getRequestDispatcher("/view/listSpThinhHang.jsp");

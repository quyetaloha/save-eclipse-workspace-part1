					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form action="${addMemberUrl }" method="post">
								...
								<input type="password" name="nlpassword"
									placeholder="Nhập lại password" /><br> <input type="text"
									name="name" placeholder="Họ tên" /> <br> <input
									type="text" name="add" placeholder="Địa chỉ" /><br> <input
									type="text" name="phone" placeholder="Số ĐT" /><br> <input
									type="radio" name="type" value="Admin" />Admin <input
									type="radio" name="type" value="Người dùng" />Người dùng<br>
								<br>

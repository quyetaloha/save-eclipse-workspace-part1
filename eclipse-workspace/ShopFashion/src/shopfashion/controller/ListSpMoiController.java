...
@WebServlet(urlPatterns = { "/product/san-pham-moi" })
public class ListSpMoiController extends HttpServlet {
	private DanhMucSanPhamDao danhMucDao = new DanhMucSanPhamDaoImp();

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		req.setAttribute("listProduct", danhMucDao.getByProduct(6));
		RequestDispatcher requestDispatcher = req.getRequestDispatcher("/view/listSpMoi.jsp");

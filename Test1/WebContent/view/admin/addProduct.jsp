					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form action="${addProductUrl}" method="post"
								...
								<input type="text" name="nameProduct" placeholder="Tên sản phẩm" /><br>
								<label for="avatar">Chọn ảnh:</label> 
								<input type="file"name="fileImage" /> <br>
								<input type="text" name="nhaSanXuat" placeholder="Nhà sản xuất" /><br>
								<input type="text" name="namSanXuat" placeholder="Năm sản xuất" /><br>
								<input type="text" name="thongTin" placeholder="Thông tin sp" /><br>
								<input type="text" name="giaMua" placeholder="Giá mua vào" /> <br>
								<input type="text" name="giaBan" placeholder="Giá bán ra" /><br>
								<c:forEach items="${listDanhMuc}" var="dsDanhMuc">
									<input type="checkbox" name="danhMuc"
										value="${dsDanhMuc.idDanhMuc}" />${dsDanhMuc.nameDanhMuc}<br>
								</c:forEach>

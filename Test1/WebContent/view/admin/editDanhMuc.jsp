				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<c:url value="/admin/danh-muc/edit" var="editDanhMucUrl"></c:url>
							<form action="${editDanhMucUrl}" method="post">
								<input type="hidden" name="idDanhMuc"
									value="${danhMuc.idDanhMuc}" /> <input type="text"
									name="nameDanhMuc" value="${danhMuc.nameDanhMuc}" />

				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<a href="<c:url value='/admin/danh-muc/add'/>">Thêm mới</a>
							<table border="1">
								<tr>
									<th>ID</th>
									<th>Tên Danh Mục</th>
								...
								<c:forEach items="${listDanhMuc}" var="dm">
									<tr>
										<td>${dm.idDanhMuc}</td>
										<td>${dm.nameDanhMuc}</td>
										<td><a
											href="<c:url value='/admin/danh-muc/edit?idDanhMuc=${dm.idDanhMuc}'/>">Sửa</a></td>
										<td><a
											href="<c:url value='/admin/danh-muc/delete?idDanhMuc=${dm.idDanhMuc}'/>">Xóa</a></td>
									</tr>
								</c:forEach>
							</table>
						</div>

...
@WebServlet(urlPatterns= {"/product/thoi-trang-be"})
public class ListThoiTrangBeController extends HttpServlet{
	private DanhMucSanPhamDao danhMucDao = new DanhMucSanPhamDaoImp();
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		req.setAttribute("listProduct", danhMucDao.getByProduct(4));
		RequestDispatcher requestDispatcher = req.getRequestDispatcher("/view/listThoiTrangBe.jsp");
